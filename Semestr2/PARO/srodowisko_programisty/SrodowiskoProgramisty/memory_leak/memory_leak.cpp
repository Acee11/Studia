//1. Przeprowadzić dynamiczną analizę wycieków pamięci przy pomocy valgrind'a 'valgrind APP' (pamiętać o kompilacji aplikacji z flagą g3)
//2. Przeprowadzić dynamiczną analizę wycieków pamięci używając lsan'a (przełącznik kompilatora) ,flaga -fsanizize=leak
