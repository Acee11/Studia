...
\date{Wroc³aw, \today}
\title{\LARGE\textbf{Podstawowe komendy i mo¿liwoœci}\\system sk³adu drukarskiego \LaTeX}
\author{Pawe³ WoŸny\thanks{\textit{E-mail}: \texttt{Pawel.Wozny@ii.uni.wroc.pl}}%
	    \and
